...
class PayPalFunctions {
	...
	function __construct()
	{
		...
		$this->paypal_listings = PPL::get_instance();

		$this->API_UserName = $ct_options['ct_paypal_api_username'];
		$this->API_Password = $ct_options['ct_paypal_api_password'];
		$this->API_Signature= $ct_options['ct_paypal_api_signature'];
			
		if($ct_options['ct_paypal_mode'] == 'live') 
		{
	...
	*/
	...
	function RedirectToPayPalFunctions ( $token )
	{		
		// Redirect to paypal.com here
