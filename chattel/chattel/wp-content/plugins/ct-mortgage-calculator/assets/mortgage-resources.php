...
$rate = array("","","interest rate graph","graph of interest rates","interest rates by country graph","bar graph of country interest rates","interest rates", "interest rates financereference.com","finance reference interest rates","interest rates around the world");
...
$ipages = array("fixed-interest-rate-loan","interest-rates","real-interest-rate","federal-funds-rate");
$ipage = getItem($ipages);

$mpages = array("mortgage-loan","mortgage","mortgage-backed-securities");
$mpage = getItem($mpages);

$defrates = array('','','','financereferenece.com'.'financereference mortgage','mortgage definitions finance reference');
...
<div align='center'>
	...
	<a href='http://www.financereference.com/learn/<?php echo $ipage; ?>'><img id='rates' style='border-color:#000;border-style:<?php echo $borderstyle;?>;border-width:<?php echo $border; ?>px' alt='<?php echo $defrate; ?>' src='http://www.financereference.com/interest-rates.png'></a><br />
