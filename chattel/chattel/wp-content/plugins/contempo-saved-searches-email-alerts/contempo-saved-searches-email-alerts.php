...
<form method="post" action="" class="ctea-alert-creation-form">
	<section class="col span_12 create-alert marB60">
		...
		<h3 class="marB5"><?php _e('Create a new email alert', 'ctea'); ?></h3>
		...
		<div class="col span_3 first">
			<label><?php esc_html_e('Type of Property (Home, Apartment)', 'ctea'); ?></label>
			<?php ct_submit_listing_form_select('property_type'); ?>
		</div>

		<div class="col span_3">
			<label><?php esc_html_e('Status (For Sale, For Rent)', 'ctea'); ?></label>
