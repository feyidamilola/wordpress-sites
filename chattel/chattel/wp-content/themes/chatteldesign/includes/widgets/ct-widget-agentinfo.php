	...
	?>
		...
		echo '<div class="widget-inner">';   
		    ...
		    <div class="details col span_12 first row">
		        <h5 class="author <?php if(empty($tagline)) { echo 'marB10'; } ?>"><a href="<?php echo site_url(); ?>/?author=<?php echo the_author_meta('ID'); ?>"><?php echo esc_html($first_name); ?> <?php echo esc_html($last_name); ?></a></h5>
		        <?php if($tagline) { ?>
