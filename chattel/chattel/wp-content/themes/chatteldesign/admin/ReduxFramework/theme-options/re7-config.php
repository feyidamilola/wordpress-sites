    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            /*array (
                ...
                'type' => 'image_select',
                'options' => ct_get_snazzy_map_styles(),
                'title' => 'Choose your Google Maps Style',
                'default' => '1',
            ),*/
        )
    ) );
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array (
                ...
                'title' => 'State, Area, Suburb, Province or Region?',
                'default' => 'state',
            ),
            array (
...
Redux::setSection( $opt_name, array(
    ...
    Redux::setSection( $opt_name, array(
        ...
        'id'               => 'yelp',
        'icon'             => 'fa fa-yelp',
        'desc'   => __( 'Set this up if you\'d like to display "What\'s Nearby?" information on your listings such as restaurants, grocery stores, schools, coffee shops, etc&hellip;. <a href="https://www.yelp.com/developers/v2/manage_api_keys" target="_blank">Get your API Key</a>! Also the "Contempo Real Estate 7 Payment Gateways" plugin needs to be installed and activated as it includes the required OAuth class.', 'contempo' ),
        'customizer_width' => '450px',
        'fields'           => array(
            array (
