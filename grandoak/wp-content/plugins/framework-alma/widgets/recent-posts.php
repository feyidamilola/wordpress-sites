...
function pt_recent_posts_widget() {
	register_widget( 'pt_recent_posts_Widget__Class' );
}


class pt_recent_posts_Widget__Class extends WP_Widget {
	...
	function __construct() { 
		...
		parent::__construct( 'pt_recent_posts_widget', __('Pixelthrone Recent Posts', 'pt_admin_framework'), $widget_ops, $control_ops );
