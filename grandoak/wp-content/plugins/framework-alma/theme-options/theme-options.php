...
$this->sections[] = array(
	...
	'fields' => array(
		...
		array(
			'id'=>'website_navigatio_type',
			'type' => 'button_set', 
			'title' => __('Website Navigation Type', 'redux-framework'),
			'subtitle'=> '',
			"default" => '1',
            'options' => array('1' => 'One Page', '2' => 'Multi-Page'),
		...
		array(
			...
			'type' => 'media',
			'url'=> false,
			'title' => __('Replace preloader gif', 'redux-framework'),
...
$this->sections[] = array(
	...
	'fields' => array(
		array(
			'id'=>'google_map__key',
			'type' => 'text',
			'title' => __('Google Map Key', 'redux-framework'),
			'desc' => __('You can add your key here. If you leave the field empty we\'ll add one of ours. <br><a href="https://console.developers.google.com/flows/enableapi?apiid=maps_backend,geocoding_backend,directions_backend,distance_matrix_backend,elevation_backend&keyType=CLIENT_SIDE&reusekey=true" target="_blank">You can create your key here..</a>', 'redux-framework'),
		),
...
$this->sections[] = array(
	...
	'fields' => array(
		...
		array(
			'id'=>'vc_posts_grid',
			'type' => 'switch', 
			'title' => __('Post Grid ', 'redux-framework'),
			'subtitle'=> '',
			"default" => 0,
			'on' => 'Enabled',
			'off' => 'Disabled',
...
$this->sections[] = array(
	...
	'fields' => array(
		...
		array(
			...
			'notice' => true,
			'style' => 'warning',
			'desc' => '<div class="loading_block"><img src="'.get_site_url().'/wp-admin/images/wpspin_light.gif" /> '. __("Loading, please wait...", "framework_localize") .'</div><div class="container_data"></div>'
			),
		// array(
		// 	'id'=>'import_revslider',
		// 	'type' => 'image_select',
