	...
	$args['comment_notes_after'] = '<div class="row htmlTags-row">
		<div class="col-md-10">
				<p class="form-allowed-tags-hover">
					...
					<span>' .  __( 'You may use these <abbr title="HyperText Markup Language">HTML</abbr> <br>tags and attributes:', 'pt_framework' ) . '</span>
				
					<p class="form-allowed-tags">
						' . sprintf( __( 'You may use these <abbr title="HyperText Markup Language">HTML</abbr> tags and attributes: %s<br>', 'pt_framework' ), ' <code>' . allowed_tags() . '</code>' ) . '
					</p>
