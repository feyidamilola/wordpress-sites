                            ...
                            echo'<li '.$brando_post_classes.'>';
                                echo'<figure>';
                                    ...
                                    if($brando_url):
                                        ...
                                        $sizes = $sizes_data = '';
                                        $sizes = wp_get_attachment_image_sizes( get_post_thumbnail_id(get_the_ID()), $brando_portfolio_srcset_data );
                                        if( $sizes ){
                                        ...
                                        echo '<div class="gallery-img">';
                                            if( $portfolio_external_url != '' ){
                                                ...
                                                echo '<img src="'.esc_url($brando_url).'" width="'.$brando_thumb[1].'" height="'.$brando_thumb[2].'"'.$brando_image_alt.$brando_image_title.$srcset_data.$sizes_data.'>';
                                            echo '</a>';
                                        echo '</div>';
                                    else : 
