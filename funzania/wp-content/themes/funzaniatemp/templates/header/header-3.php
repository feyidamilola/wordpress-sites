...
?>
    <nav class="navbar no-margin-bottom alt-font center-logo-header no-border bg-turquoise-blue header-vertical-center<?php echo esc_attr($brando_header_text_color);?><?php echo $brando_enable_non_sticky;?>">
        <div class="container navigation-menu">
            <div class="row text-center">
                ...
                ?>
                    <div class="col-lg-2 col-md-2 pull-right header-right text-right<?php echo $brando_call_to_action ?>">
