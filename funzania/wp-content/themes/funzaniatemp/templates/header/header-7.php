...
?>
    <nav class="navbar no-margin-bottom alt-font no-border without-border header-vertical-center<?php echo esc_attr($brando_header_text_color);?><?php echo $brando_enable_non_sticky;?>">
