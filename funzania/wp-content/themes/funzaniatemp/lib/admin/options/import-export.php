...
if( brando_is_theme_licence_active() ) {
    ...
    $brando_import_export_content .= '<div class="import-content demo-licence-not-activated">
        <div class="licence-not-activated"><i class="fa fa-info-circle"></i><span>'.__( 'Please activate your Brando theme license copy to enjoy premium feature of demo data import.', 'brando' ).'</span></div><br>
