...
if( !empty( $brando_options['brando_portfolio_url_slug'] ) ) {
	$args[ 'rewrite' ] = array( 'slug' => trim( $brando_options['brando_portfolio_url_slug'] ) );
}
...
if( !empty( $brando_options['brando_portfolio_categories_url_slug'] ) ) {
	$args[ 'rewrite' ] = array( 'slug' => trim( $brando_options['brando_portfolio_categories_url_slug'] ) );
}
...
if( !empty( $brando_options['brando_portfolio_tags_url_slug'] ) ) {
	$args[ 'rewrite' ] = array( 'slug' => trim( $brando_options['brando_portfolio_tags_url_slug'] ) );
}
