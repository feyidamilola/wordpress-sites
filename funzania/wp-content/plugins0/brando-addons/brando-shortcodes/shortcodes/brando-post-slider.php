                                    ...
                                    $output .='<div class="post-details display-inline-block text-left">';
                                        ...
                                        $output .='<div class="col-md-10 col-sm-12 no-padding">';
                                            ...
                                            if( $brando_show_post_meta == 1 ){
                                                $output .='<span class="text-extra-small text-uppercase display-block alt-font medium-gray-text margin-one-top author vcard"'.$brando_author_color.'>'.__('Posted by ','brando-addons').'<a href="'.esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ).'" class="medium-gray-text url fn n"'.$brando_author_color.'>'.get_the_author_meta( 'user_nicename', $post_author).'</a></span>';
                                            }
