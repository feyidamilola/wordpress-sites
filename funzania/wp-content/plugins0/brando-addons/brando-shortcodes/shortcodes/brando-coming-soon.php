...
if ( ! function_exists( 'brando_coming_soon_shortcode' ) ) {
    function brando_coming_soon_shortcode( $atts, $content = null ) {
        ...
        /* Social icon color */
        ( $brando_coming_soon_social_icon_color ) ? $tz_featured_array[] = '.'.$brando_token_class.' .footer-social a i{ color:'.$brando_coming_soon_social_icon_color.';}' : '';
                            ...
                            $output .= '<div class="row">';
                                $output .= '<div class="col-md-12 col-sm-12 col-xs-12 text-center margin-seven-bottom xs-margin-eight-bottom">';
                                    ...
                                    if( $brando_coming_soon_date ){
                                        $output .= '<div id="counter-event" data-enddate="'.$brando_coming_soon_date.'" class="countdown-timer text-center alt-font center-col margin-six-top"'.$brando_coming_soon_notify_me_counter_color.'></div>';
                                    }
                                $output .= '</div>';
                            $output .= '</div>';
                            $output .= '<div class="row">';
