...
brando_meta_box_dropdown('brando_enable_sticky_single',
				esc_html__('Sticky Header', 'brando-addons'),
				array('default' => esc_html__('Default', 'brando-addons'),
					  '1' => esc_html__('Yes', 'brando-addons'),
					  '0' => esc_html__('No', 'brando-addons')
					 )
			);
brando_meta_box_dropdown('brando_hide_menu_onclick_single',
				esc_html__('Hide Menu Onclick', 'brando-addons'),
				array('default' => esc_html__('Default', 'brando-addons'),
					  '1' => esc_html__('Yes', 'brando-addons'),
					  '0' => esc_html__('No', 'brando-addons')
					 )
...
brando_meta_box_dropdown('brando_enable_callto_mobile_single',
				esc_html__('Call to action in mobile', 'brando-addons'),
				array('default' => esc_html__('Default', 'brando-addons'),
					  '1' => esc_html__('Yes', 'brando-addons'),
					  '0' => esc_html__('No', 'brando-addons')
					 )
