...
if( !class_exists('Brando_Addons') ) {
  class Brando_Addons {
    ...
    public function __construct() {
      add_action( 'plugins_loaded', array($this,'brando_addons_load_plugin_textdomain') );
      ...
      require_once( BRANDO_ADDONS_ROOT.'/widgets/brando-latest-portfolio.php' );
      require_once( BRANDO_ADDONS_ROOT.'/widgets/brando-portfolio-categories.php' );
      require_once( BRANDO_ADDONS_ROOT.'/extend-options/extend-options.php' );
    }

    /* Load plugin textdomain. */
    public function brando_addons_load_plugin_textdomain() {
      load_plugin_textdomain( 'brando-addons', false, plugin_basename( dirname( __FILE__ ) ) . '/languages' ); 
    }
