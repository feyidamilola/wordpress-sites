...
<div class="static-position">
    ...
    <?php 
    if(LEE_WOO_LATEST) :
        echo '<input type="hidden" name="lt-woo-latest" value="1" />';
    endif;
    $lt_thumbnail = function_exists('wc_get_image_size') ? wc_get_image_size('shop_thumbnail') : null;
    $lt_size_thumb = $lt_thumbnail ? ($lt_thumbnail['width'] . 'x' . $lt_thumbnail['height']) : '';
    echo '<input type="hidden" name="lt-product-thumb-size" value="' . $lt_size_thumb . '" />';
    ?>
</div>
</body>
</html>