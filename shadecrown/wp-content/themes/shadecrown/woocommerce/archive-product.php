...
<div <?php echo $attr;?>>
    ...
    <div class="lt_shop_description"><?php echo lt_term_description($catId, $lt_type_page); ?></div>
    ...
    <?php woocommerce_product_loop_start(); ?>
        ...
        <?php elseif ( ! woocommerce_product_subcategories( array( 'before' => woocommerce_product_loop_start( false ), 'after' => woocommerce_product_loop_end( false ) ) ) ) : ?>
            <li class="row"><?php wc_get_template( 'loop/no-products-found.php' ); ?></li>
        <?php endif; ?>
...
<div class="lt-has-filter-ajax hidden-tag">
    <div class="current-cat hidden-tag">
        <a data-id="<?php echo (int)$catId;?>" href="<?php echo $lt_href_page; ?>" class="lt-filter-by-cat" id="lt-hidden-current-cat" data-taxonomy="<?php echo esc_attr($lt_type_page);?>"></a>
    </div>
