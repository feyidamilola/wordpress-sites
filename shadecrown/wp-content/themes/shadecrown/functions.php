...
defined('LEE_WOO_LATEST') or define('LEE_WOO_LATEST', LEE_WOOCOMMERCE_ACTIVED ? version_compare($woocommerce->version, '3.0.1', ">=") : false);
...
function lt_scripts() {
    ...
    wp_enqueue_style( 'lt-style', get_stylesheet_uri(), array(), '1.0.8' , 'all');
    ...
    wp_enqueue_script( 'lt-theme-js', get_template_directory_uri() .'/js/min/main.min.js', array(), '1.0.1' , true );
