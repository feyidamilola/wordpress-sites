...
if ( ( ! isset($ajax) || ! $ajax ) && ! $product->is_visible() ) :
    return;
endif;
...
if(isset($is_deals) && $is_deals) $time_sale = get_post_meta( $product->get_id(), '_sale_price_dates_to', true );
