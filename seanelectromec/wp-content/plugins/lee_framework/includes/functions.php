    ...
    switch ($type) {
        ...
        case 'featured_product':
            if (!LEE_WOO_LATEST) {
                ...
                $args['tax_query'] = $woocommerce->query->get_tax_query();
...
add_action('init', 'lt_check_woo_latest');
function lt_check_woo_latest() {
    global $woocommerce;
    
    defined('LEE_WOO_LATEST') or define('LEE_WOO_LATEST', $woocommerce ? version_compare($woocommerce->version, '3.0.1', ">=") : false);
}